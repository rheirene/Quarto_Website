...
Publication_record_table %>%
  ...
  tab_style(
    style = cell_borders(sides = c("t"),
                              ...
                              weight = px(2)), 
                         locations = list(cells_footnotes(), cells_source_notes())) %>%
  gt_color_rows(Extreme_sport, palette = c("#202B2A", "#289998"), domain = c(0,3)) %>% 
  gt_color_rows(Alcohol, palette = c("#202B2A", "#289998"), domain = c(0,3)) %>% 
  gt_color_rows(Gambling, palette = c("#202B2A", "#289998"), domain = c(0,3)) %>% 
  gt_color_rows(Science_reform, palette = c("#202B2A", "#289998"), domain = c(0,3)) %>% 
  gt_color_rows(Other, palette = c("#202B2A", "#289998"), domain = c(0,3)) %>% 
    cols_label(
