...
I recently contributed to a conceptual paper discussing the landscape of open science in behavioural addictions research led by [Dr Charlotte Eben](https://twitter.com/CharlotteEben) who is doing some great work in this space! Find out more [here](https://robheirene.netlify.app/publication/2023-open-science-landscape-eben-heirene/).
...
gam_prevention_data<- read.csv("_files/gamb_prevention_data.csv") %>%
  select(Layer:colours)
...
```{=html}
<iframe src="fig.html" class="fade-inhtmlAll" width="100%" height="750" style="border:none;"></iframe>
```
