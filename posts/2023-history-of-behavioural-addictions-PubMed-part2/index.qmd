...
data_locations <- data_id %>%
 ...
 mutate(
    ...
    institution = map2(institution, max_length, ~ replace(., seq_along(.) + 1 > .y, NA_character_)),
    author_names = map2(author_names, max_length, ~ replace(., seq_along(.) + 1 > .y, NA_character_))
  ) %>%
