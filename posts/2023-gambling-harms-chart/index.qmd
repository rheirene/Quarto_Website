...
As I (re-)read the literature on this topic, I'll also create a record of relevant studies and sources relating to each prevention strategy. **This section is even more undeveloped than the chart, so the same call for suggestions applies.**
