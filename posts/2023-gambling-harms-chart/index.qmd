...
# gam_prevention_data<- read.csv("posts/2023-gambling-harms-chart/gamb_prevention_data.csv") %>% select(Layer:Description)
...
-   This [UK Gambling Commission report](https://www.gamblingcommission.gov.uk/about-us/guide/consumer-voice-2020-exploring-online-staking) from 2020 discusses consumer perspectives on stake limits (n=32). Qual/quant survey with PGSI scores.
