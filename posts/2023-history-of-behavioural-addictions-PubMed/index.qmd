...
total_year_gganimate <- data_total_per_year_pubs %>%
  ...
  geom_text(aes(x = 2001, y =260, label = gam_DSMV_label), hjust = 0, vjust = 0, alpha = 0.9, col = "#F5F7F0", size = 4, family = "Reem Kufi") +
  # Add final year label
  geom_text(aes(x = 2013, y =530, label = final_year_label), hjust = 0, vjust = 0, alpha = 0.9, col = "#F5F7F0", size = 4, family = "Reem Kufi") +
# Define x-axis dates
  ...
  # Define theme elements
   theme(
     ...
     plot.title = element_text(color = "#289998", size = 16, margin = margin(b = 15))
