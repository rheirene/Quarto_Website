...
packages <- c('readr', # Load dataset from GitHib
              ...
              'htmlwidgets', 
              'scico') # Colour palette) # Make plotly plots HTML format for rendering in Quarto
...
data <- read_csv(url_behav_addic_data_link) %>%
  as_tibble()
...
palette_colors <- rev(scico(n = num_labels, palette = 'davos'))
