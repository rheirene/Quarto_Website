...
```{r results=FALSE, warning=FALSE, message=FALSE, results=FALSE}
#| code-fold: true
#| code-summary: "Code: load dataset"

raw_data <- read_csv(url("https://raw.githubusercontent.com/rheirene/pub-med-scape-behav-addictions/main/Data%20extraction/combined_results_clean.csv?token=GHSAT0AAAAAACFNISZMISA65FOPSMYTTPOOZHFLN6Q"))
  ...
  scale_x_continuous(breaks = seq(1960, 2020, by = 10)) +  
   ...
   theme(
     ...
     # panel.border = element_rect(color = "#002B36")
      # panel.border.bottom = element_rect(color = "#F5F7F0")  # Re-add bottom panel border
   )  +
   labs(
...
animate(total_year_gganimate, width = 750, height = 380, rewind = FALSE)
